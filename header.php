        ...
        <header class="bg-zinc-800">
            <nav class="py-4 flex justify-end items-center container mx-auto">
                <div class="space-x-4 mr-4">
                    ...
                    <a href="registrationpage" class="hover:text-zinc-300 hover-effect">Registration</a> <!-- Changed to  -->
                    <a href="contact" class="hover:text-zinc-300 hover-effect">Contact</a> <!-- Changed to  -->
                    <a href="about_this_site" class="hover:text-zinc-300 hover-effect">About this Site</a> <!-- Changed to  -->
                </div>
            </nav>
        </header>
        </div>
