    ...
    <main class="flex flex-col items-center justify-center min-h-screen p-4">
        ...
        <div class="youtube-live-stream w-full max-w-4xl">
            ...
            <div style="position: relative; width: 100%; padding-bottom: 56.25%;">
                <iframe style="position: absolute; top: 0; left: 0; width: 100%; height: 100%;" src="https://www.youtube.com/embed/ACSSXGP7nNY?si=dqmZzKPw-6o7cdqW" title="Printers Only Live Stream" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
            </div>
        </div>
